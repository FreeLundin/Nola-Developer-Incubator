...
- Quick launch page (auto-generated by `ps1/start-public-dev.ps1`): [docs/launch.html](./docs/launch.html)
...
Use the included PowerShell helper to start the dev server and a temporary public tunnel (Cloudflare `cloudflared` required):

```powershell
# Make executable and run once
Unblock-File .\ps1\start-public-dev.ps1; .\ps1\start-public-dev.ps1
```

The script will open a public URL in your browser, write `docs/browser-qr.svg`, and create `docs/launch.html` — share that `launch.html` or the public URL with testers.
